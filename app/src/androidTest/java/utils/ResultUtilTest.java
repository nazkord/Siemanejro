...
public class ResultUtilTest {
    ...
    public void testResult3() {
        ...
        assertEquals(Integer.valueOf(3), ResultUtil.getResult(score1, score2));
    }
    ...
    public void testResult2() {
        ...
        assertEquals(Integer.valueOf(2), ResultUtil.getResult(score1, score2));
    }
    ...
    public void testResult0_1() {
        ...
        assertEquals(Integer.valueOf(0), ResultUtil.getResult(score1, score2));
    }
    ...
    public void testResult4Draw() {
        ...
        Score score2 = new Score(null, "DRAW", new FullTimeResult(null, 0, 0));
        assertEquals(Integer.valueOf(4), ResultUtil.getResult(score1, score2));
    }
